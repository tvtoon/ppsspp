...
QtGLGraphicsContext::QtGLGraphicsContext()
{
 CheckGLExtensions();
...
void QtGLGraphicsContext::Shutdown() {}

void QtGLGraphicsContext::SwapInterval(int interval)
{
// See TODO in constructor.
// renderManager_->SwapInterval(interval);
}

void QtGLGraphicsContext::SwapBuffers() {}
void QtGLGraphicsContext::Resize() {}

Draw::DrawContext *QtGLGraphicsContext::GetDrawContext()
{
 return draw_;
}

void QtGLGraphicsContext::ThreadStart() { renderManager_->ThreadStart(draw_); }
bool QtGLGraphicsContext::ThreadFrame() { return renderManager_->ThreadFrame(); }
void QtGLGraphicsContext::ThreadEnd() { renderManager_->ThreadEnd(); }

void QtGLGraphicsContext::StopThread()
{
