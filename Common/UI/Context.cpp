...
void UIContext::PushTransform(const UITransform &transform) {
	...
	Vec3 scaledTranslate = Vec3(
		t.x * m.m4x4float.xx + t.y * m.m4x4float.xy + t.z * m.m4x4float.xz + m.m4x4float.xw,
		t.x * m.m4x4float.yx + t.y * m.m4x4float.yy + t.z * m.m4x4float.yz + m.m4x4float.yw,
		t.x * m.m4x4float.zx + t.y * m.m4x4float.zy + t.z * m.m4x4float.zz + m.m4x4float.zw);
